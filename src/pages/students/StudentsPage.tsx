  ...
  import StudentsPageHeader from '../../components/headers/StudentsPageHeader';
  import StudentsEditModal from '../../components/modals/StudentsEditModal';
  import DeleteModal from '../../components/modals/DeleteModal';
  import SharedTable from '../../components/commons/SharedTable';
  
  const StudentsPage: React.FC = function () {
    ...
    const handleEdit = async (id, data) => {
      try {
        const response = await fetch(`/api/sessions/update/${id}`, {
          method: 'PUT',
    ...
    const columns = [
    { key: 'studentId', header: 'participant' },
